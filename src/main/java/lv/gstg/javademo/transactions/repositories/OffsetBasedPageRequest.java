...
/**
 * Offset based Pageable<br>
 * Credit goes to Ergin, codingmonkey
 *
 * @see <a href="https://stackoverflow.com/questions/25008472/pagination-in-spring-data-jpa-limit-and-offset">Pagination in Spring Data JPA (limit and offset)</a>
 */
public class OffsetBasedPageRequest implements Pageable, Serializable {
    ...
    private OffsetBasedPageRequest(long offset, int limit) {
    ...
    public Pageable withPage(int pageNumber) {
        throw new RuntimeException("NotSupportedException withPage");
    }
